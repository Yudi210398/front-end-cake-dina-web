        ...
        <div className="grid gap-4  grid-cols-1 lg:grid-cols-12">
          <div className="col-span-12 flex flex-col justify-evenly relative">
            ...
            <h3 className=" text-grey500  opacity-75 text-lg font-normal text-center lg:text-justify pt-8">
              Kami berkomitmen untuk menghadirkan kue terbaik bagi Anda. Setiap
              kue dibuat dengan perhatian dan dedikasi tinggi, memastikan setiap
              potongan menawarkan rasa yang memuaskan dan menggugah selera.
              Segera pesan dan nikmati kelezatan yang kami tawarkan!
            </h3>
